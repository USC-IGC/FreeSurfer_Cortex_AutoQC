...
columns = list(pd.read_csv(args.maindir + '/features.csv').Features)
...
#Scaling
minmax = pickle.load(open(args.maindir + '/models/minmax.sav', 'rb'))
...
for selected_roi in roi_list:
    ...
    file = args.maindir + '/models/model_' + str(selected_roi) + '.sav'
